      ...
      <Container className="center pt-5" fluid="xl">
        <Row>
          <Col sm className='pb-4'>
            ...
            <p>A small but lovely garden located in south Brisbane</p>
          ...
          <Col sm className='pb-4'>
            ...
            <ul className='row row-cols-2 px-0 my-0'>
              <li className="col list-unstyled mb-2"><Link to="/">Home</Link></li>
              <li className="col list-unstyled mb-2"><Link to="/account">My Account</Link></li>
        ...
        <hr />
        <p className="text-center small text-secondary pb-3 mb-0">©2022 Jack's Garden All rights reserved</p>
      </Container>
    </Container>
  )
}
